...
from pina import DisPINNADMassSpring
...
class PlotterADMassSpring:
    ...
    def plot_same_training_test_data(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        mdic = {"predicted_output_AD_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):predicted_output_array, "pts_array_AD_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):pts_array}
        savemat("Results/Mass_Spring/MassSpring_Dis_AD_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic)
    ...
    def plot_loss(self, pinn, label = None, log_scale = True):
        ...
        mdic_loss = {"epochs_dis_AD_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):epochs, "loss_dis_AD_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):loss}
        savemat("Results/Mass_Spring/MassSpring_loss_dis_AD_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic_loss)
