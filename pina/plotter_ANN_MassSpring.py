...
from pina import DisPINNANNMassSpring
...
class PlotterANNMassSpring:
    ...
    def plot_same_training_test_data(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        mdic = {"predicted_output_ANN_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):predicted_output_array, "pts_array_ANN_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):pts_array}
        savemat("Results/Mass_Spring/MassSpring_Dis_ANN_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic)
    ...
    def plot_loss(self, pinn, label = None, log_scale = True):
        ...
        mdic_loss = {"epochs_dis_ANN_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):epochs, "loss_dis_ANN_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):loss}
        savemat("Results/Mass_Spring/MassSpring_loss_dis_ANN_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic_loss)
