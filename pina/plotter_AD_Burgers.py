...
class PlotterAD:
    ...
    def plot_same_training_test_data(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        savemat("Results/Burgers/Burgers_Dis_AD_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic)
    ...
    def plot_loss(self, pinn, label = None, log_scale = True):
        ...
        savemat("Results/Burgers/Burgers_loss_dis_AD_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic_loss)
