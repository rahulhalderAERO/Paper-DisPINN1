...
class PlotterLSTMReduced:
    ...
    def plot_same_training_test_data(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        mdic = {"predicted_output_LSTMReduced_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):predicted_output_array, "pts_array_LSTMReduced_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):pts_array}
        savemat("Results/Burgers_Reduced/Burgers_Dis_LSTMReduced_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic)
    ...
    def plot_loss(self, pinn, label = None, log_scale = True):
        ...
        mdic_loss = {"epochs_dis_LSTMReduced_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):epochs, "loss_dis_LSTMReduced_{}_{}".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()):loss}
        savemat("Results/Burgers_Reduced/Burgers_loss_dis_LSTMReduced_{}_{}.mat".format(pinn.problem.rand_choice_integer_Data(),pinn.problem.runtype()), mdic_loss)
