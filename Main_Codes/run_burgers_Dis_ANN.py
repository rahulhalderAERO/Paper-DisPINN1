...
from pina import DisPINNANNBurgers, PlotterANN, LabelTensor
     ...
     for Type_Run in Type_Run_list:
       ...
       if args.s:
        pinn.span_tensor_given_pts(
            ...
            locations=['D'])
        pinn.train(6000, 1)
        pinn.save_state('pretrained_model/Burgers/ANN_pina.burger_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
        
       else:
        pinn.load_state('pretrained_model/Burgers/ANN_pina.burger_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
        plotter = PlotterANN()        
