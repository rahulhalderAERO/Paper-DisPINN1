...
from problems.burgers_tensor_discrete_LSTM_pointwise_Residual import Burgers1D
     ...
     for Type_Run in Type_Run_list:
       ...
       if args.s:
        pinn.span_tensor_given_pts(
            ...
            locations=['A','D','F'])
        pinn.train(6000, 1)
        pinn.save_state('pretrained_model/Burgers_External/LSTM_pina.burger_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
       else:
        pinn.load_state('pretrained_model/Burgers_External/LSTM_pina.burger_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
