     ...
     for Type_Run in Type_Run_list:
       ...
       if args.s:
        pinn.span_tensor_given_pts(
            ...
            locations=['D','gamma'])
        pinn.train(5000, 1)        
        pinn.save_state('pretrained_model/Mass_Spring/LSTM_pina.MassSpring_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
       else:
        pinn.load_state('pretrained_model/Mass_Spring/LSTM_pina.MassSpring_dis.{}_{}_{}'.format(args.id_run,cut_Data,Type_Run))
