...
u_red_1000 = scipy.io.loadmat('../Results/Burgers_Reduced/Burgers_Dis_{}Reduced_{}_Physics.mat'.format(method,Data_used))['predicted_output_{}Reduced_{}_Physics'.format(method,Data_used)].T
u_full_1000 = np.matmul(phi,u_red_1000)
...
cb = getattr(ax[1], 'contourf')(x_actual,time_actual,abs(u_full_1000-u_actual))
